...
public class Camino implements Comparable<Camino> {
	...
	public int compareTo(Camino o) {
		// if( this.distancias[distancias.length-1] - o.distancias[distancias.length-1]
		// == 0 )
		// return 1;
	...
	public Queue<Arista> obtenerCamino() {
		...
		while (nodoEnElQueEstoyParado != 0) {
			camino.add(new Arista(this.camino[nodoEnElQueEstoyParado], nodoEnElQueEstoyParado, 1));
